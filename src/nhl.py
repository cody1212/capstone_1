...
if __name__=="__main__":
    ...
    def data_form(df,yr,start,st_year=2019,default=1,df_or_dict=0):
        tms = {}
        nhl = df
        yr1 = int(yr)
        if default != 0:
            for i in range(st_year-yr1):
    ...
    stop_yr = int(yr)+1
    # teams1 = data_form(nhl,yr,start,stop_yr)
    # print(teams1)
    # default = 0
    def get_points(dic):
        team_points = {}
